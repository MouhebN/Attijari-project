...
@Component({
  selector: 'app-cheque32',
  templateUrl: './cheque32.html',
  styleUrl: './cheque32.scss',
  standalone: true,
  imports: [CommonModule, FormsModule, AdvancedSearchComponent, AdvancedDataTableComponent]
})
export class Cheque32Component implements OnInit {
  fichiers: Fichier[] = [];
  ...
  loadFichiers(): void {
    this.fichierService.getFichiersByNatureAndCodeValeur('Chèque', '32').subscribe({
      next: (data: Fichier[]) => {
        this.fichiers = data;
